...
<head>
  ...
  <title>AK BUSINESS - Boxed Layout</title>
  <style>
    body {
      margin: 0;
...
<body>
 <!-- HOME -->
  <section class="section" id="home">
    <h2>Home</h2>
    <p>Welcome to <strong>AK BUSINESS</strong> — where your business vision becomes reality with smart and modern solutions.</p>
  </section>

  <!-- ABOUT -->
  <section class="section" id="about">
    <h2>About Us</h2>
    <p>AK BUSINESS is committed to delivering premium services that empower clients and help businesses grow with digital tools and expert strategies.</p>
  </section>

  <!-- SERVICES -->
  <section class="section" id="services">
    <h2>Our Services</h2>
    <p>We offer website design, branding, digital marketing, consulting, and customized tech solutions tailored to your business needs.</p>
  ...
  <section class="section" id="contact">
    <h2>Contact Us</h2>
    <p>Feel free to reach out for collaborations or questions. We’re just a message away.</p>
    <div style="text-align:center;">
...
<head>
  <meta charset="UTF-8" />
  <title>AK BUSINESS - Box Sections</title>
  <style>
    body {
      margin: 0;
      font-family: Arial, sans-serif;
...
<!-- About Us Box -->
    <div class="box">
      <h2>About Us</h2>
      <p>
        At <strong>AK BUSINESS</strong>, we specialize in helping businesses grow through smart technology, digital solutions, and dedicated service.
      </p>
    </div>
  ...
  <!-- Our Services Box -->
   <div class="box">
      <h2>Our Services</h2>
      <p>
        We provide website development, branding, digital marketing, and consultancy to take your business to the next level with modern tools and strategies.
      </p>
    </div>
