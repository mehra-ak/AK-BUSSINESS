...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0"/>
  <title>Modern Red & White Design</title>
...
<body>
  ...
  <header>
    <h1>AK BUSINESS</h1>
    <p>Modern Red & White Website Theme</p>
  </header>

  <div class="section">
    <h2>Welcome</h2>
    <p>This is a clean and modern section with red and white background colors.</p>
  </div>

  <footer>
    © 2025 AK BUSINESS. All rights reserved.
  </footer>
